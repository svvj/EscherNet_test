...
#data_type="RTMV"
#T_ins=(1 2 3 5 10)
#data_dir="./demo/data/RTMV/40_scenes/"
...
#data_type='MVDream'
#T_ins=(4)
#data_dir="./demo/MVDream/"

## Text2Img, 1 view to 100
#data_type='Text2Img'
#T_ins=(1)
#data_dir="./demo/Text2Img/"
...
for T_in in "${T_ins[@]}"; do
    ...
    python eval_eschernet_ours.py --pretrained_model_name_or_path "$pretrained_model" \
                         --data_dir "$data_dir" \
                         --data_type "$data_type" \
                          --cape_type "$cape_type" \
                         --T_in "$T_in"
